...
{
    /// <summary>
    /// DTO utilisé pour la mise à jour d'une Recette.
    /// </summary>
    public class ModifyRecetteDTO
    {
        /// <summary>
    ...
    /// </summary>
    public class ModifyRecetteDTOValidator : AbstractValidator<ModifyRecetteDTO>
    {
        /// <summary>
        /// Initialise les règles de validation pour la mise à jour d'une Recette.
        /// </summary>
        public ModifyRecetteDTOValidator()
        {
